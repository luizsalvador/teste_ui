/**
* @pollyjs/adapter-puppeteer v5.1.0
*
    ...
    createClass(PuppeteerAdapter, [{
      ...
      value: function _callListenersWith(methodName, target) {
        if (this[LISTENERS].has(target)) {
          var listeners = this[LISTENERS].get(target); // puppeteer remove prependListener after v4.0.0, polyfill it if missing

          var prependListenerPolyfill = function prependListenerPolyfill(event, handler) {
            var all = this.emitter.all;
            var handlers = all.get(event);
          ...
          for (var eventName in listeners) {
            var prependListener = target.prependListener || prependListenerPolyfill;
            var fn = methodName === 'prependListener' ? prependListener : target[methodName];
