...
class PuppeteerAdapter extends Adapter {
  ...
  _callListenersWith(methodName, target) {
    if (this[LISTENERS].has(target)) {
      const listeners = this[LISTENERS].get(target); // puppeteer remove prependListener after v4.0.0, polyfill it if missing
      ...
      for (const eventName in listeners) {
        const prependListener = target.prependListener || prependListenerPolyfill;
        const fn = methodName === 'prependListener' ? prependListener : target[methodName];
